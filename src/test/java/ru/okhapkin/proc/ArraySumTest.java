...
import static ru.okhapkin.proc.AddressingMode.*;
import static ru.okhapkin.proc.Command.*;
import static ru.okhapkin.proc.Registers.*;
...
public class ArraySumTest {
    ...
    void arraySumTest() {
        ...
        dataMemory.getMemory()[0] = 1; // Размер массива
        ...
        // THEN
        Assertions.assertEquals(10, cpu.getAcc().value());
    }
